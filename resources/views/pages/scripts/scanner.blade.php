...
function renderScannerScopeInfo() {
    ...
    function applyScannerModeUI() {
        ...
        if (manualInput) {
            manualInput.placeholder = useRfid ? 'Scan/Ketik UID RFID...' : 'Scan/Ketik kode karyawan...';
    ...
    function loadKelasSuggestions() {
        console.log("Memuat daftar Gedung / Divisi dari Konfigurasi...");
            ...
            console.error('Gagal memuat daftar gedung / divisi:', err);
            existingClasses = [];
            populateAllClassDropdowns();
...
function populateAllClassDropdowns() {
    ...
    function renderKelasDropdown(items) {
        ...
        if (!items || items.length === 0) {
            dropdown.innerHTML = '<div class="px-4 py-3 text-xs text-gray-400 italic">Gedung / Divisi tidak ditemukan. Ketik untuk membuat baru.</div>';
            return;
        }
...
function refreshData(type) {
        ...
        if (type === 'siswa') {
            ...
            loadDataGuru();        
            showAlert('success', 'Data admin diperbarui.');
        }
